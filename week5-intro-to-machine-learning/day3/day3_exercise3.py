# Same as exercise 2, but only change the value of alpha
# Vary Regularization Parameters:
  # 1. Experiement with different values of alpha (eg. 0.1, 1, 10) for Ridge and Lasso Regression
  # 2. Observe how the model's coefficients and performance change
...
# # Ridge alpha=0.1 and Lasso alpha=1
# # Ridge Regression
...
# # Ridge alpha=0.1 and Lasso alpha=10
# # Ridge Regression
# ridge_model = Ridge(alpha=0.1)
# ridge_model.fit(X_train, y_train)
# ridge_predictions = ridge_model.predict(X_test)
...
# # Ridge alpha=0.1 and Lasso alpha=0.1
# # Ridge Regression
# ridge_model = Ridge(alpha=0.1)
# ridge_model.fit(X_train, y_train)
# ridge_predictions = ridge_model.predict(X_test)
...
# # Ridge alpha=1 and Lasso alpha=1
# # Ridge Regression
...
# # Ridge alpha=1 and Lasso alpha=0.1
# # Ridge Regression
# ridge_model = Ridge(alpha=1)
# ridge_model.fit(X_train, y_train)
# ridge_predictions = ridge_model.predict(X_test)
...
# # Ridge alpha=10 and Lasso alpha=0.1
# # Ridge Regression
...
# # Ridge alpha=10 and Lasso alpha=1
# # Ridge Regression
# ridge_model = Ridge(alpha=10)
# ridge_model.fit(X_train, y_train)
# ridge_predictions = ridge_model.predict(X_test)
...
# Ridge alpha=10 and Lasso alpha=10
# Ridge Regression
ridge_model = Ridge(alpha=10)
ridge_model.fit(X_train, y_train)
ridge_predictions = ridge_model.predict(X_test)
