...
# Build, train, and optimize a CNN for CIFAR-10 image classification, experimenting with regularization and data augmentation to achieve the best performance
...
class EnhancedCNN(nn.Module):
  def __init__(self):
    ...
    # Calculate the size of output from convolutional layers dynamically
