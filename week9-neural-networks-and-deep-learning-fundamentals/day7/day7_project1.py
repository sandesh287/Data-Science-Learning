...
print(f'Baseline Model Test Accuracy: {accuracy}')
...
# Compile improved model with learning rate scheduler
...
print(f'Improved Model Test Accuracy: {improved_accuracy}')
